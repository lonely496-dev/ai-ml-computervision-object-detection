...
1. Check `RUN_SCENARIOS.md` for detailed examples
2. Run `python test_all.py` to verify setup
...
- **MediaPipe** - Google's pose and face detection solutions
...
**Made with ❤️ for pose and face detection enthusiasts**
